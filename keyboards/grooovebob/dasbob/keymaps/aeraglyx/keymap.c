...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BAS] = LAYOUT_split_3x5_3(
        ...
        LCTL_T(KC_N),       RALT_T(KC_R),       LSFT_T(KC_T),       LCTL_T(KC_S),       KC_G,               KC_F,               RSFT_T(KC_H),       RCTL_T(KC_E),       RALT_T(KC_A),       KC_I,
    ...
    [_SYM] = LAYOUT_split_3x5_3(
        ...
        LSFT(KC_1),         LCTL(KC_9),         LCTL(KC_0),         KC_EQL,             KC_SCLN,            LSFT(KC_2),         LSFT_T(KC_EQL),     KC_MINS,            LSFT(KC_SCLN),      KC_BSLS,
    ...
    [_REF] = LAYOUT_split_3x5_3(
        ...
        KC_N,               KC_R,               KC_T,               KC_S,               KC_G,               KC_F,               KC_H,               KC_K,               KC_L,               KC_I,
